  ...
  <footer class="footer">
    <div class="columns">
      ...
      <div class="column is-4 info">
        ...
        <br />
        <small>Powered by <a href="https://vuejs.org" class="vue" target="_blank">
          <span class="green">Vue</span><span class="blue">.js</span></a>
        </small>
        <br />
    ...
    <div class="container">
      <div class="content has-text-centered">
        <p>Made with ❤️ by <a href="http://cedricamaya.me" target="_blank">Cedric Amaya</a>.
